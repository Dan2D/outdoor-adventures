    ...
    return (
        <div className='explore-msg-container'>
            ...
            <div className='flex-container d-flex justify-content-between'>
                ...
                <SVG className='explore-msg__svg' src={require("../../Images/hours-icon.svg")} preProcessor={code => code.replace(/fill=".*?"/g, 'fill="white"')}/>
            </div>
            <div className='flex-container d-flex justify-content-between'>
            <SVG className='explore-msg__svg' src={require("../../Images/bell-icon.svg")} preProcessor={code => code.replace(/fill=".*?"/g, 'fill="white"')} />
            ...
            <div className='flex-container d-flex justify-content-between'>
                ...
                <SVG className='explore-msg__svg' src={require("../../Images/moon-icon.svg")} preProcessor={code => code.replace(/fill=".*?"/g, 'fill="white"')} />
            </div>
